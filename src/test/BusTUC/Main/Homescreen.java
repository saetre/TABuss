...
public class Homescreen extends Activity{
	...
	private void loadDictionaries()
	{
		...
		catch(Exception e)
		{
			...
			Toast.makeText(context, "Fant ikke SD-kort. Sjekk innstillnger, og start app p� nytt", Toast.LENGTH_LONG).show();
		}
	...
	class OracleThread extends AsyncTask<Void, Void, Void>
	{
		...
		String noRoutes = "Fant ingen ruter for søkekriterie. Sjekk s�keord";
		...
		protected void onPreExecute()
		{
			...
			if(sms)	Toast.makeText(context, "Venter p� svar...", Toast.LENGTH_LONG).show();
